            ...
            <div>
                {posts.map(post => {
                    ...
                    <div className="flex gap-4">
                        ...
                        className="text-pink-600 fleex items-center justify-center gap-2 py-2 text-sm">
                            <BsTrash2Fill />
                            Delete
                        </button>
                        <Link href={{ pathname: "/post", query: post }}>
                            <button className="text-teal-600 fleex items-center justify-center gap-2 py-2 text-sm">
                                <AiFillEdit />
                                Edit
                            </button>
                        </Link>
